        ...
        <div v-for="article in articles" :key="article._path">
          <NuxtLink :href="article._path">
            ...
            <div class="px-6 py-4">
              ...
              <span class="inline-block bg-black rounded-full px-3 py-1 text-sm font-semibold text-white mr-2 mb-2">{{ new Date(article.date).toLocaleDateString("de-DE")}}</span>              <p class="text-gray-700 text-base">
                {{ article.description}}
              </p>
            </div>
